(function(){'use strict';var module=angular.module('ui.grid.autoScroll',['ui.grid']);module.service('uiGridAutoScrollService',['uiGridConstants','$timeout',function(uiGridConstants,$timeout){var service={initializeGrid:function(grid,$scope){service.defaultGridOptions(grid.options);if(!grid.options.enableAutoScroll){return;}
